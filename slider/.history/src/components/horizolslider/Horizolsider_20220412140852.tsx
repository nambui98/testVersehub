                ...
                <Slider {...settings}>
                    {
                        listItem.map((item, index) =>
                            <Item className={`${index === activeIndex ? "active" : (activeIndex - index) === 1 || (index - activeIndex) === 1 || (index - activeIndex) === listItem.length || (index - activeIndex) === -listItem.length ? "near" : ""}`}>
